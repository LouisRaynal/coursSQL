...
INSERT INTO Patients (nom, prénom, ville, code_postal, numéro_tel)
    VALUES ('Johns','Edith','La Roche-sur-Yon','85000','0641547451');
INSERT INTO Patients (nom, prénom, ville, code_postal, numéro_tel)
    VALUES ('Johns','Michael','La Roche-sur-Yon','85000','0641544471');
...
INSERT INTO Consultations (id_patient, id_médecin, date_heure_début)
    VALUES (2, 1, '2022-10-22 15:30:00')
;
...
SET date_heure_fin = '2022-10-22 16:15:00'
WHERE id_consult = 1
;
